      ...
      <section className="py-12 px-4 bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm" style={{ height: '380px' }}>
            <iframe
              title="Matrix Mobile Tyres coverage area"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79087.57!2d-1.5199!3d52.4081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870a06f7e1b1d7f%3A0x93d6d62f8f5ebe0a!2sCoventry%2C%20UK!5e0!3m2!1sen!2suk!4v1699000000000!5m2!1sen!2suk"
            />
          </div>
          <p className="text-center text-xs text-slate-400 mt-3">We cover all areas within approximately 15 miles of Coventry city centre</p>
        </div>
      </section>
